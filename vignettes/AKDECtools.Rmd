...
The following are a set of functions that evaluate input water quality data, filtered using *filterCat3samples,* against Alaska's surface water quality standards (WQS) using a crosswalk table. The crosswalk table was developed by AK DEC and Tetra Tech and can be retrieved from within the package using the code below.
