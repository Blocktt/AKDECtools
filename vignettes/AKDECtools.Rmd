...
|---------------------|-----------------|-----------------|-----------------|
| simplePull                  | data                   | df_ExampSamps           |                                    |
| simplePull                  | AU_ID                  | *User specified*        | *NA*                               |
| simplePull                  | constituent            | *User specified*        | *NA*                               |
| filterCat3samples           | data_samples           | df_ExampSamps           |                                    |
| filterCat3samples           | data_sufficiency       | df_Data_Sufficiency     |                                    |
| MagDurFreq                  | wqs_crosswalk          | df_WQS_Crosswalk        |                                    |
| MagDurFreq                  | input_samples_filtered | *Use filterCat3samples* | *NA*                               |
| MagDurFreq                  | input_sufficiency      | df_Data_Sufficiency     |                                    |
| MagDurFreq_hardness         | wqs_crosswalk          | df_WQS_Crosswalk        |                                    |
| MagDurFreq_hardness         | input_samples          | df_ExampSamps           |                                    |
| MagDurFreq_hardness         | input_samples_filtered | *Use filterCat3samples* | *NA*                               |
| MagDurFreq_hardness         | input_sufficiency      | df_Data_Sufficiency     |                                    |
| MagDurFreq_pH               | wqs_crosswalk          | df_WQS_Crosswalk        |                                    |
| MagDurFreq_pH               | input_samples          | df_ExampSamps           |                                    |
| MagDurFreq_pH               | input_samples_filtered | *Use filterCat3samples* | *NA*                               |
| MagDurFreq_pH               | input_sufficiency      | df_Data_Sufficiency     |                                    |
| MagDurFreq_turbidity        | wqs_crosswalk          | df_WQS_Crosswalk        |                                    |
| MagDurFreq_turbidity        | input_samples_filtered | *Use filterCat3samples* | *NA*                               |
| MagDurFreq_turbidity        | input_sufficiency      | df_Data_Sufficiency     |                                    |
| MagDurFreq_turbidity        | reference_sites        | *NA*                    |                                    |
...
| boxPlot                     | data                   | df_ExampSamps           |                                    |
| boxPlot                     | WQS_table              | df_WQS_Crosswalk        |                                    |
| boxPlot                     | AU_ID                  | *User specified*        | *NA*                               |
| boxPlot                     | y_axis_log             | *User specified*        | *TRUE/FALSE*                       |
| timeSeries                  | data                   | df_ExampSamps           |                                    |
| timeSeries                  | WQS_table              | df_WQS_Crosswalk        |                                    |
| timeSeries                  | AU_ID                  | *User specified*        | *NA*                               |
| timeSeries                  | y_axis_log             | *User specified*        | *TRUE/FALSE*                       |
| freshwaterAmmoniaWarning    | input_sufficiency      | *df_Data_Sufficiency*   |                                    |
| findTurbidityReferenceSites | input_samples_filtered | *df_ExampSamps*         |                                    |
...
-   **MagDurFreq**: Applies water quality standards for all characteristics that are not hardness-, pH-, or turbidity.
...
| Rule                                      | Explanation                                                                                      | IR Category |
|-----------------|---------------------------------------|-----------------|
| cat_5\_present == 0 & cat_2\_present == 0 | Of the Individual Category results, there are none in Category 2 or Category 5                   | 3           |
| cat_5\_present == 0 & cat_2\_present \> 0 | Of the Individual Category results, there are none in Category 5, but at least one in Category 2 | 2           |
| cat_5\_present \> 0                       | Of the Individual Category results, there is at least one in Category 5                          | 5           |
