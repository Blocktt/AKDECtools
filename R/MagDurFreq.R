...
#' * input_samples_filtered: AUID_ATTNS, ActivityStartDate, AU_Type, ActivityStartTime.Time,
#' TADA.ResultMeasureValue, TADA.ActivityDepthHeightMeasure.MeasureValue
